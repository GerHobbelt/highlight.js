...
export default function(hljs) {
  ...
  var PREPROCESSOR = {
    ...
    keywords: {
      'meta-keyword': 'assert define elif elifdef elifndef else endif error if ifdef ' +
  ...
  var ATS_SPECIAL_KEYWORDS = {
    ...
    keywords: {
      'meta-keyword': 'arrpsz arrptrsize delay ldelay effmask effmask_ntm ' +
  ...
  var ATS_KEYWORDS = {
    keyword: 'abstype abst0ype abst@ype absprop absview absvtype absviewtype ' +
    ...
    built_in: 'bool char schar uchar float uint lint ulint llint ullint size_t ' +
