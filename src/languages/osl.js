...
export default function(hljs) {
  ...
  var PREPROCESSOR = {
    ...
    keywords: {
      'meta-keyword': 'define undef if ifdef ifndef elif else endif include pragma'
    },
    contains: [{
        begin: /\\\n/,
        relevance: 0
  ...
  return {
    ...
    keywords: {
      ...
      type: 'point vector normal float int color matrix string void',
      built_in:
        // Constants
    ...
    contains: [
      ...
      {
        className: 'class',
        beginKeywords: 'surface displacement volume shader',
        end: '\\('
      },
      hljs.C_NUMBER_MODE,
      {
